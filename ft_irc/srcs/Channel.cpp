...
/*   Updated: 2025/06/03 14:21:24 by gcapa-pe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Channel::printChannelInfo() const {
    std::cout << GRE << B << "Channel Name: " << _name << R << std::endl;
    std::cout << GRE << B << "Clients in channel: " << _clients.size() << R << std::endl;
    for (size_t i = 0; i < _clients.size(); ++i) {
        std::cout << GRE << B << "Client " << i + 1 << ": " 
